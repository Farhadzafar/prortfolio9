export const translations = {
  ...
  ar: {
    ...
    timeZoneFlexibility:
      "نحن مرنون جدًا فيما يتعلق بالتواصل عبر المناطق الزمنية.",
    ...
    assistedDevelopment:
      "المساعدة في تطوير منصة ويب باستخدام احدث تقنية، مما عزز التفاعلية.",
    ...
    digitalPresence:
      "هل أنت مستعد للارتقاء بحضورك الرقمي و التكنولوجي إلى المستوى التالي؟",
    reachOut:
      "تواصل معنا اليوم ودعونا نناقش كيف يمكننا مساعدتك في تحقيق أهدافك.",
